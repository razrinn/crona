...
var usePercentageStats = function usePercentageStats() {
  var response = fetchData(_url__WEBPACK_IMPORTED_MODULE_2__["dailyUrl"]);
  var recentData = response ? response.data[response.data.length - 1] : [];
  return recentData ? recentData.map(function (data) {
    return {
      persentasePasiendalamPerawatan: data.persentasePasiendalamPerawatan,
      persentasePasienSembuh: data.persentasePasienSembuh,
      persentasePasienMeninggal: data.persentasePasienMeninggal
    };
  }) : null;
};
...
//# sourceMappingURL=index.js.2c4e80ca4047d0b088e5.hot-update.js.map